...
INPUT_PATH = r"W:\Desktop\data-gen"
OUTPUT_PATH = rf"C:\Users\{sys.argv[3]}\SandBox"
MESSAGE_PATH = os.path.join(OUTPUT_PATH, "messages.txt")

PRM_RAW = r"prm_raw.prm"
PRM_TXT = r"prm_txt.prm"

MESH_DIR = r"w:/stl_2cm" if os.path.exists(r"w:/stl_2cm") else rf"C:\Users\{sys.argv[3]}\stl_2cm"
JSON_PATH = os.path.join(INPUT_PATH, "simple_train_test.json")
NETFABB_PATH = r"C:\Program Files\Autodesk\Netfabb Ultimate 2025\SIM\Solver\bin"

TIME_LIMIT = 10 # minutes of simulation time allowed per part
...
if __name__ == "__main__":
    ...
    for idx in range(start, end):
        ...
        if success_run==False:
            print_progress(time.time()-start_script_time, f"Part {idx} simulation failed in {time.time()-start_time:.2f} seconds.\n{part}")
